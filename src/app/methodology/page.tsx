      ...
      <main className="mx-auto max-w-[1100px] px-4 sm:px-6">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Card title="Найм + Ley Beckham" source={["lirpf_93", "rirpf_114", "rirpf_116"]}>
            <ol className="list-decimal space-y-1.5 pl-5 text-sm leading-relaxed text-ink-2">
              <li>
                Кому доступен (проверка на главной): не были налоговым резидентом Испании 5 лет до переезда; переехали из-за работы по
                найму (в том числе удалённой на иностранного работодателя или по направлению), должности администратора, бизнеса с
                отчётом ENISA или работы на стартап; супруг и дети до 25 лет могут присоединиться (art. 93.3); подали modelo 149 в течение 6 месяцев с даты alta в Seguridad Social. Действует в год
          ...
          <Card title="Autónomo" source={["lirpf_30", "lgss_308", "lirpf_32"]}>
            <ol className="list-decimal space-y-1.5 pl-5 text-sm leading-relaxed text-ink-2">
              ...
              <li>IRPF — как у найма, но без 2 000 € и без art. 20.</li>
              <li>Первый год: tarifa plana {n2(P.ss.reta.tarifaPlanaMonthly)} € (80 € + MEI) и −20% рендимьенто (art. 32.3 LIRPF).</li>
            </ol>
          </Card>
